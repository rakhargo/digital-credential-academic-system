        ...
        <section className="min-h-screen flex font-sans">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center bg-[#151924] text-white p-6 sm:p-12 lg:p-24">
                <div className="w-full max-w-md">
                            ...
                            <div className="flex items-start">
                                <div className="flex items-center h-5">
                                    <input 
                                        ...
                                        type="checkbox" 
                                        className="w-4 h-4 border border-[#374151] rounded bg-[#212936] text-cyan-500 focus:ring-2 focus:ring-cyan-500 checked:bg-cyan-500 checked:border-transparent" 
                                        style={{ accentColor: '#06B6D4' }} 
                                    />
                                </div>
                                <div className="ml-3 text-sm">
                                    <label htmlFor="remember" className="text-[#9CA3AF]">Remember me</label>
                                </div>
                            </div>
                            <a href="#" className="text-sm font-medium text-cyan-400 hover:underline">Lupa Password?</a>
                        </div>
                    ...
                    <p className="text-sm font-light text-[#9CA3AF] mt-6">
                        Tidak punya akun? <a href="/register" className="font-medium text-teal-400 hover:underline">Daftar Sekarang</a>
                    </p>
                </div>
            </div>
